...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <meta name="author" content="PIXINVENT">
     <title>View Complaints  - VTA</title>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          if($type=='admin')
          {
            ...
            <ul class="menu-content">
              ...
              <li class="active"><a href="view_complaint.php" data-i18n="nav.cards.card_bootstrap" class=" menu-item">view complaints</a>
              </li>
          ...
          {
            ?>
           <li class="nav-item"><a href="make_complaint.php"><i class="icon-copy"></i><span data-i18n="nav.changelog.main" class="menu-title">Make Complaint</span></a>
          </li>

           <li  class="nav-item active"><a href="view_complaint.php"><i class="icon-eye6"></i><span data-i18n="nav.changelog.main" class="menu-title">View Complaints</span></a>
          </li>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">View Complaints</h2>
          </div>
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">View Complaints
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="row">
              <div class="col-xs-12">
                  <div class="card card-inverse">
                         ...
                         <h4 ><center>VIEW UPLOADED COMPLAINTS</center> </h4>
            ...
            if($type=='parent'||$type=='student'||$type=='staff'||$type=='non-teaching staff')
            {
              ?>
                            ...
                            <tr>
                                <th width="10%" class="yellow">complaint ID</th>
                                <th width="20%" class="orange">Complaint Title</th>
                                <th width="30%" class="purple">Complaint Type</th>
                                <th width="20%" class="red">Status</th>
                               <!-- <th></th> -->
                            </tr>
                        
                          <?php 
                      
                        $query1=mysqli_query($conn,"SELECT * FROM `complaints` WHERE `cust_name`='$name'");
                          ...
                          ?>
                            <tr>
                               ...
                               <!-- <td><button type="button" class="btn mr-1 mb-1 btn-primary btn-sm">Small button</button> 
                                </td> 
                                <td>
            ...
            if($type=='admin')
            {
              ?>
                            ...
                            <tr>
                                ...
                                <th width="10%" class="red">Status</th>
                               <!-- <th></th> -->
                            </tr>
                        
                          <?php 
                      
                        $query1=mysqli_query($conn,"SELECT * FROM `complaints` ");
                          while ($row=mysqli_fetch_array($query1)) {
                  ...
                  if($type=='grievancecellmember')
            {
              ?>
                        ...
                        $query1=mysqli_query($conn,"SELECT * FROM `complaints` WHERE `gcm_name`='$name' ");
                          while ($row=mysqli_fetch_array($query1)) {
                            $cmpdate=$row['create_date'];
                             list($date,$encrpt)=explode(" ",$cmpdate);
