...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <meta name="author" content="PIXINVENT">
     <title>Assign Complaints  - VTA</title>
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          if($type=='admin')
          {
           ...
           <li class="active"><a href="assigncomplaints.php" data-i18n="nav.cards.card_bootstrap" class="menu-item">Assign complaints</a>
              </li>
          ...
          if($type=='grievancecellmember')
          {
           ...
           <li><a href="view_complaint.php" data-i18n="nav.cards.card_bootstrap" class="menu-item">view complaints</a>
              ...
              <li class="active"><a href="assigncomplaints.php" data-i18n="nav.cards.card_bootstrap" class="menu-item">un-attended complaints</a>
              </li>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Un-Attended Complaints
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="col-xs-12">
                  <div class="card card-inverse">
                       ...
                       if($type=='admin')
                        {
                         ?>
                          <center>ASSIGN COMPLAINTS</center> 
                          <?php
                        }
                        elseif ($type=='grievancecellmember') {
                          ?>
                          <center>UN-ATTENDED COMPLAINTS</center> 
                          <?php
                          # code...
                        }
                        ?>
                       ...
                       if($type=='admin')
            {
              ?>
                            ...
                            <tr>
                                ...
                                <th width="10%" class="red">action</th>
                               <!-- <th></th> -->
                            </tr>
                        
                          <?php 
                      
                        $query1=mysqli_query($conn,"SELECT * FROM `complaints` WHERE status='open' ");
                          ...
                          ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['comp_type']; ?></td>
                                 ...
                                 <td><form  action="work_complaints.php" method="POST"> 
                                 <input type="hidden" name="comp_id" value="<?php echo $row['cid']; ?>"/>                         
                           <input type="submit" value="Action" name="action" class="btn btn-xs btn-success" /> 
                  ...
                  if($type=='grievancecellmember')
            {
              ?>
                            ...
                            <tr>
                                ...
                                <th width="30%" class="orange">Comp_Title</th>
                                <th width="30%" class="purple">Comp_Type</th>
                                <th width="20%" class="black">Status</th>
                                <th width="10%" class="red">Actions</th>
                               <!-- <th></th> -->
                            </tr>
                        
                          <?php 
                      
                        $query1=mysqli_query($conn,"SELECT * FROM `complaints` WHERE `gcm_name`='$name' AND `status`='Assigned' ");
                          while ($row=mysqli_fetch_array($query1)) {
                            $cmpdate=$row['create_date'];
                             list($date,$encrpt)=explode(" ",$cmpdate);
                          ...
                          ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['status']; ?></td>
                                 <td><form  action="work_complaints.php" method="POST" enctype="multipart/form-data"> 
                                  <input type="hidden" name="comp_id" value="<?php echo $row['cid']; ?>"/>                                                        
                           <input type="submit" name="action" value="Edit" class="btn btn-xs btn-success" /> 
